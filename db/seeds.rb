...
# Group.create(name: "Nobels", description: "All of the various leaders and nobels in the Wheel of Time universe.")
Group.create(name: "Government Officials", description: "Various Mayors and Govenors in the Wheel of Time universe,")
